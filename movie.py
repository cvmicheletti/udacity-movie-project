...
class Movie(object):
    ...
    Atrributes will be the specific values for a movie vs a tv show.
    Methods for setter/getters and displaying various visual attributes are
    provided.

    Instance Variables:
    __VALID_MOVIE_RATINGS__:  Constant contains MPAA movie ratings data
        which is pulled in from an external pickled file.
